    ...
    <div className="flex flex-1 flex-col gap-4">
      ...
      <div className="flex-1 grid text-sm md:text-base px-10   bg-red-5 grid-cols-2 sm:grid-cols-4 gap-2 gap-y-4 text-white">
        <div className="flex-1 flex flex-col gap-2 justify-between">
          <HashLink to={"/about"} className="font-bold text-lg sm:pb-6">About Us</HashLink>
        ...
        <div className="flex-1 flex flex-col gap-2 justify-between">
          <HashLink  to={"/services"} className="font-bold text-lg sm:pb-6">Services</HashLink>
        ...
        <div className="flex-1 flex flex-col gap-2 justify-between">
          <HashLink to={"https://elemaths.shop/products/"} target="_blank" className="font-bold text-lg sm:pb-6">Products</HashLink>
        ...
        <div className="flex-1 flex flex-col gap-2 justify-between">
          <HashLink to={"/contact"} className="font-bold text-lg sm:pb-6">Contact Us</HashLink>
