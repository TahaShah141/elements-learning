  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="flex flex-col md:gap-4">
        ...
        <div className="flex flex-col sm:flex-row p-16 lg:px-44 px-4 gap-4 justify-center">
          ...
          <h1 className=" font-bold text-3xl text-center sm:hidden">Fill out the Form</h1>
            <input type="text" placeholder="Your Name" className="bg-[#F3EEE8] rounded-md p-3 text-xs   w-full"/>
            <input type="text" placeholder="Enter Your Email" className="bg-[#F3EEE8] rounded-md p-3 text-xs  w-full"/>
            <textarea type="text" placeholder="Your Message" className="md:flex-1 bg-[#F3EEE8] rounded-md p-3 h-32 text-xs  w-full"/>
            <button className="bg-[#FBBA41] rounded-md p-2 text-sm font-bold">Submit</button>
          </SlidingDiv>
          <SlidingDiv direction={"right"} className="flex-[1.5_0_0] flex flex-col gap-4">
            <div className="flex gap-2 p-4 rounded-md bg-[#F3EEE8]">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-sm">IAEC, NUST H-12 Islamabad</p>
              </div>
            </div>
            <div className="flex gap-2 p-4 rounded-md bg-[#F3EEE8]">
              ...
              <div className="flex flex-col gap-2">
                <p className="text-lg font-bold">Mail Us</p>
                <p className="text-sm">info@elements-learning.com</p>
              </div>
            </div>
            <div className="flex gap-2 p-4 rounded-md bg-[#F3EEE8]">
              ...
              <div className="flex flex-col gap-2">
                <p className="text-lg font-bold">Telephone</p>
                <p className="text-sm">+92 327 8698770</p>
              </div>
            </div>
          </SlidingDiv>
        </div>
