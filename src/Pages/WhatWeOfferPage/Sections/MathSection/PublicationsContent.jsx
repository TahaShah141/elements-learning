            ...
            <div className="py-2 xs:py-4 md:py-6 lg:py-8">
              <div className="flex flex-col-reverse sm:flex-row gap-2">
                <div className="flex-[3_0_0] flex flex-col text-right p-4 md:p-8 lg:p-10 xl:p-12 gap-4 lg:gap-6 xl:gap-8 bg-[#F3EEE8]">
                  ...
                  <p className="text-xs sm:text-sm md:text-base xl:text-lg"> By incorporating best practices based on the CPA methodology, and innovative methods from educational theorists such as Jerome Bruner, Richard Skemp, Zoltán Pál Dienes, and Caleb Gattegno, our textbooks ensure a comprehensive and effective learning experience.</p>
                  <div className="flex gap-2 mt-auto justify-end">
                    <button className="lg:px-6 lg:py-4 p-2 font-bold md:text-lg lg:text-lg text-white bg-[#FBBA42]">Teacher Guide</button>
                    <button className="lg:px-6 lg:py-4 p-2 font-bold md:text-lg lg:text-lg text-white bg-[#353535]">Student Workbooks</button>
                  </div>
                </div>
          ...
          },
          {
            ...
            <div className="py-2 xs:py-4 md:py-6 lg:py-8">
              <div className="flex flex-col sm:flex-row gap-2">
                ...
                <div className="flex-[3_0_0] flex flex-col p-4 md:p-8 lg:p-10 xl:p-12 gap-4 lg:gap-6 xl:gap-8 text-xs sm:text-sm md:text-base xl:text-lg bg-[#F3EEE8]">
