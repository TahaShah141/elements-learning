...
export const BlogCard = ({id, title, author, date, summary}) => {
  return (
    <Link to={`/blogs/${id}`} className="flex-1 group min-w-64 md:min-w-96 shadow-lg rounded-md border flex flex-col gap-4 p-6">
      ...
      <p className="text-xs md:text-sm text-neutral-400 group-hover:text-light-black">
