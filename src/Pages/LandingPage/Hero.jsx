...
export const Hero = () => {
  return (
    <>
      <div className="py-10 xs:py-24 md:max-w-lg flex w-full flex-col gap-4 lg:gap-8">
        <StaggeredHeaders containerClass="px-6 xs:px-10 md:px-0 text-4xl xs:text-7xl sm:text-8xl md:text-7xl lg:text-8xl text-[#353535] font-bold" headers={["Life", "Long", "Learning."]}/>
        <SlidingDiv className="px-6 xs:px-10 md:px-0" direction={"bottom"} px={10} delay={1}>
          <p className="text-xs xs:text-base lg:text-lg">Welcome to Elements Learning (EL), where we're reshaping K-12 education from the ground up.</p>
        </SlidingDiv>
        ...
        <div className="w-full py-4 xs:py-8 gap-4 flex flex-col md:hidden overflow-hidden">
          <SlidingDiv className="flex gap-4 justify-end w-full" direction={"right"} px={50} delay={0.5}>
            <div className="size-20 xs:size-40 justify-center bg-[#F67E1F] flex items-end overflow-hidden rounded-[30px] xs:rounded-[50px] xs:rounded-br-none rounded-br-none">
              <img src="/landingpage/pic02.png" className="h-full" alt="" />
            </div>
            <div className="size-20 xs:size-40 justify-center bg-[#02AEEE] flex items-end overflow-hidden rounded-[30px] xs:rounded-[50px] xs:rounded-tl-none rounded-tl-none">
              <img src="/landingpage/pic03.png" className="h-full" alt="" />
            </div>
            <div className="h-20 w-20 xs:h-40 xs:w-28 bg-[#FBBB40] xs:rounded-tl-[50px] rounded-tl-[30px]"></div>
          </SlidingDiv>
          <SlidingDiv className="flex gap-4 flex-1" direction={"left"} px={50} delay={1}>
            <div className="h-20 w-20 xs:h-40 xs:w-28 bg-[#74BE43] rounded-br-[30px] xs:rounded-br-[50px]"></div>
            <div className="h-20 xs:h-40 w-3/5 justify-center bg-[#F8EA01] flex items-end overflow-hidden rounded-[30px] xs:rounded-[50px] xs:rounded-tr-none rounded-tr-none">
