    ...
    <>
      <div className="flex flex-col gap-2 items-center">
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <p className="xs:text-xl sm:text-2xl text-md ">Students</p>
        </div>
      </div>
      <div className="flex flex-col gap-2 items-center">
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <p className="xs:text-xl sm:text-2xl text-md">Teachers</p>
        </div>
      </div>
      <div className="flex flex-col gap-2 items-center">
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <p className="xs:text-xl sm:text-2xl text-md">Parents</p>
        </div>
      </div>
      <div className="flex flex-col gap-2 items-center">
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <p className="xs:text-xl sm:text-2xl text-md">Schools</p>
        </div>
      </div>
    </>
  )
