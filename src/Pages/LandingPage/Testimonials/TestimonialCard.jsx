export const TestimonialCard = ({quote, person}) => {
  ...
  return (
    <div className="bg-[#F3EEE8] flex flex-col justify-center px-6 sm:px-10 lg:px-16 gap-2 rounded-xl md:rounded-3xl md:rounded-bl-none rounded-bl-none text-xs md:text-base lg:text-lg md:max-w-[400px] lg:max-w-[600px] py-4 xs:py-2 min-h-72 xs:min-h-64 min-[550px]:min-h-80 md:min-h-[400px] lg:min-h-[500px]">
