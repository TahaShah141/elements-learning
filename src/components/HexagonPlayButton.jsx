...
export const HexagonPlayButton = ({outerColor="#000000", innerColor="#FFFFFF"}) => {
  return (
    <div className="relative size-full">
      ...
      <svg style={{color: innerColor}} className="size-2/5 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>play</title><path d="M8,5.14V19.14L19,12.14L8,5.14Z" fill="currentColor"/></svg>
    </div>
  )
}
