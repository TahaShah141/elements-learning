...
export const Footer = () => {
  return (
    <footer className="bg-[#353535] p-4">
      <div className="border-b border-white px-12 py-20 w-full flex flex-col gap-32 justify-center ">
        
        <div className="flex flex-1 gap-8">
          
          <div className="flex-1 flex flex-col gap-4">
            <div className="p-4 px-8 rounded-full rounded-br-none bg-[#FBBA41] font-bold">FAQs</div>
            <div className="flex-1 px-12 flex flex-col gap-8 text-white">
              <p className="text-sm">
          ...
          <div className="flex-1 flex flex-col gap-4">
            <div className="p-4 px-8 rounded-full rounded-br-none bg-[#FBBA41] font-bold">Location</div>
            <div className="flex-1 px-12 flex gap-8 text-white">
              <div className="flex-1 flex-col flex gap-6">
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex gap-2 items-center px-4">
                    <svg className="size-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M6.62,10.79C8.06,13.62 10.38,15.94 13.21,17.38L15.41,15.18C15.69,14.9 16.08,14.82 16.43,14.93C17.55,15.3 18.75,15.5 20,15.5A1,1 0 0,1 21,16.5V20A1,1 0 0,1 20,21A17,17 0 0,1 3,4A1,1 0 0,1 4,3H7.5A1,1 0 0,1 8.5,4C8.5,5.25 8.7,6.45 9.07,7.57C9.18,7.92 9.1,8.31 8.82,8.59L6.62,10.79Z" fill="currentColor"/></svg>
                    <p className="text-lg">0300 0000000</p>
                  </div>
                  <div className="flex gap-2 items-center px-4">
                    <svg className="size-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>email</title><path d="M20,8L12,13L4,8V6L12,11L20,6M20,4H4C2.89,4 2,4.89 2,6V18A2,2 0 0,0 4,20H20A2,2 0 0,0 22,18V6C22,4.89 21.1,4 20,4Z" fill="currentColor"/></svg>
                    <p className="text-lg">info@elementslearning.com</p>
                  </div>
              ...
              <div className="flex flex-1 bg-neutral-700 rounded-2xl aspect-square">
        ...
        <div className="flex flex-1 gap-8">
          ...
          <div className="flex-1 grid grid-cols-4 grid-rows-4 gap-2 text-white">
      ...
      <div className="text-white font-bold flex justify-between p-4 text-lg">
